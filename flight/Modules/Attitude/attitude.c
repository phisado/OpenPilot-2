...
#if !defined(USE_STM32103CB_NAZE32)
...
#if defined(ACCEL_FILTER_USE_FOURTH_ORDER)
...
static fourthOrderData filterParams_acc[3];
static fourthOrderData filterParams_grot[3];

/**
 *
 *
 */
static float computeFourthOrder(float currentInput, fourthOrderData * filterParameters)
{
	float output;
...
#endif /* ACCEL_FILTER_USE_FOURTH_ORDER */
